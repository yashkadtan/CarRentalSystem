...
public class Main {
    public static void main(String[] args) {
        ...
        List<Vehicle> vehicles = addVehicels();
        ...
        Location location = new Location(500032, "Hyderabad", "Telangana", "India");
        ...
        //6. trip completed. submit the vehicles and close the reservation
